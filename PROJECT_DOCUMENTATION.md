...
- [docs/application/Pipeline_Invariants.md](docs/application/Pipeline_Invariants.md) — extraction pipeline Layer 4 invariants (provenance, chunker, router, glossary).
- [docs/platform-engineering/PE_Infrastructure_Invariants.md](docs/platform-engineering/PE_Infrastructure_Invariants.md) — Docker/platform Layer 4 invariants (container-parity, config-totality).
