<!-- MIRROR: auto-synced from notes/projects/covenant/PE_RM_Phase1.md - do not edit directly. Edit the canonical file in the notes repo and run scripts/sync_pe_docs.py -->
